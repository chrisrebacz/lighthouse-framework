...
/*
|----------------------------------------------------------------
| BASED ON RESTRICTED SITE ACCESS FROM 10UP
|----------------------------------------------------------------
...
class RestrictSiteAccess
{
    ...
    /**
     * Handles initializing this class and returning the singleton instance 
     * after it's been cached.
     *
    ...
    */
    public static function settings_field_allowed($args = array())
    {
		...
		<div class="hide-if-no-js">
			<div id="ip_list">
				<div id="ip_list_empty" style="display: none;">
                    <input type="text" name="rsa_options[allowed][]" value="" readonly="true" /> 
			...
			<div>
                ...
                <input class="button" type="button" id="addip" value="<?php _e('Add'); ?>" />
