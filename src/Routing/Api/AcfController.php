...
class AcfController extends WP_REST_Controller
{
    protected $type;
    ...
    public function __construct($type)
    {
        ...
        $this->namespace = 'lighthouse/v1/acf';
    ...
    {
        if ($this->type) {
            add_filter( 'rest_prepare_' . $this->type, [$this, 'rest_prepare'], 10, 3 );
            add_action( 'rest_insert_' . $this->type, [$this, 'rest_insert'], 10, 3 );
        }
    }
